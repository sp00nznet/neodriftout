...
/* $01DD0C-$01DD14  (3 instructions, 8 bytes) */
void jt_01DD0C(void) {
    M68K_OR8(g_m68k.d[2], 0x2);
    /* TODO $01DD10: roxr.l d1, d5  [E2 B5] */
    /* TODO $01DD12: dc.w $4300  [43 00] */
    /* WARNING: function did not end with RTS */
}

/* $01DD20-$01DD28  (3 instructions, 8 bytes) */
void jt_01DD20(void) {
    M68K_OR8(g_m68k.d[2], 0x2);
    /* TODO $01DD24: roxr.l d1, d7  [E2 B7] */
    /* TODO $01DD26: dc.w $4300  [43 00] */
    /* WARNING: function did not end with RTS */
}

/* $01DD34-$01DD48  (9 instructions, 20 bytes) */
void jt_01DD34(void) {
    M68K_OR8(g_m68k.d[2], 0x2);
    M68K_ROL32(g_m68k.d[4], g_m68k.d[4]);
    /* TODO $01DD3A: dc.w $4300  [43 00] */
    M68K_ROL32(g_m68k.d[1], 0x4);
    /* TODO $01DD3E: dc.w $4300  [43 00] */
    M68K_LSL32(g_m68k.d[2], g_m68k.d[4]);
    /* TODO $01DD42: dc.w $4300  [43 00] */
    M68K_ROL32(g_m68k.d[7], g_m68k.d[4]);
    /* TODO $01DD46: dc.w $4300  [43 00] */
    /* WARNING: function did not end with RTS */
}

/* $01DD48-$01DD54  (5 instructions, 12 bytes) */
void jt_01DD48(void) {
    M68K_OR8(g_m68k.d[2], 0x2);
    /* TODO $01DD4C: dc.w $e9c0  [E9 C0] */
    /* TODO $01DD4E: dc.w $4300  [43 00] */
    /* TODO $01DD50: dc.w $e9c6  [E9 C6] */
    /* TODO $01DD52: dc.w $4300  [43 00] */
    /* WARNING: function did not end with RTS */
}

/* $01DD5C-$01DD6C  (7 instructions, 16 bytes) */
void jt_01DD5C(void) {
    M68K_OR8(g_m68k.d[2], 0x2);
    M68K_LSL8(g_m68k.d[4], 0x1);
    /* TODO $01DD62: dc.w $4300  [43 00] */
    /* TODO $01DD64: dc.w $e9c7  [E9 C7] */
    /* TODO $01DD66: dc.w $4300  [43 00] */
    /* TODO $01DD68: dc.w $e9c1  [E9 C1] */
    /* TODO $01DD6A: dc.w $4300  [43 00] */
    /* WARNING: function did not end with RTS */
}

/* $01DD70-$01DD84  (5 instructions, 20 bytes) */
void jt_01DD70(void) {
    M68K_OR8(g_m68k.d[2], 0x2);
    M68K_OR8(g_m68k.d[0], 0x0);
    M68K_OR8(g_m68k.d[0], 0x0);
...
/* $01DD84-$01DD98  (5 instructions, 20 bytes) */
void jt_01DD84(void) {
    M68K_OR8(g_m68k.d[2], 0x2);
    M68K_OR8(g_m68k.d[0], 0x0);
    M68K_OR8(g_m68k.d[0], 0x0);
...
/* $01DD98-$01DDA0  (2 instructions, 8 bytes) */
void jt_01DD98(void) {
    M68K_OR8(g_m68k.d[2], 0x2);
    M68K_OR8(g_m68k.d[0], 0x0);
    /* WARNING: function did not end with RTS */
...
/* $01DDD4-$01DF58  (193 instructions, 388 bytes) */
void jt_01DDD4(void) {
    ...
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DDF0: roxl.b #$1, d0  [E3 10] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL8(g_m68k.d[0], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DDF8: roxl.b d1, d0  [E3 30] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[0], 0x1);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE00: roxl.w #$1, d0  [E3 50] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[0], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE08: roxl.b #$1, d1  [E3 11] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL8(g_m68k.d[1], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE10: roxl.b d1, d1  [E3 31] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[1], 0x1);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE18: roxl.w #$1, d1  [E3 51] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[1], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE20: roxl.b #$1, d2  [E3 12] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL8(g_m68k.d[2], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE28: roxl.b d1, d2  [E3 32] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[2], 0x1);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE30: roxl.w #$1, d2  [E3 52] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[2], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE38: roxl.b #$1, d3  [E3 13] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL8(g_m68k.d[3], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE40: roxl.b d1, d3  [E3 33] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[3], 0x1);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE48: roxl.w #$1, d3  [E3 53] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[1], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE50: roxl.b #$1, d4  [E3 14] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL8(g_m68k.d[4], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE58: roxl.b d1, d4  [E3 34] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[4], 0x1);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE60: roxl.w #$1, d4  [E3 54] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[2], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE68: roxl.b #$1, d5  [E3 15] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL8(g_m68k.d[5], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE70: roxl.b d1, d5  [E3 35] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[5], 0x1);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE78: roxl.w #$1, d5  [E3 55] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[1], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE80: roxl.b #$1, d6  [E3 16] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL8(g_m68k.d[6], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE88: roxl.b d1, d6  [E3 36] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[6], 0x1);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE90: roxl.w #$1, d6  [E3 56] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[2], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DE98: roxl.b #$1, d7  [E3 17] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL8(g_m68k.d[7], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DEA0: roxl.b d1, d7  [E3 37] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[7], 0x1);
    M68K_NOT8(g_m68k.d[0]);
    /* TODO $01DEA8: roxl.w #$1, d7  [E3 57] */
    M68K_NOT8(g_m68k.d[0]);
    M68K_LSL16(g_m68k.d[1], g_m68k.d[1]);
    M68K_NOT8(g_m68k.d[0]);
