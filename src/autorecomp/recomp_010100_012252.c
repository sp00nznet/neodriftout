...
/* $011020-$011028  (2 instructions, 8 bytes) */
void jt_011020(void) {
    { func_table_call(0x01109C); return; }
    { func_table_call(0x011074); return; }
    /* WARNING: function did not end with RTS */
}

/* $011028-$0110A2  (30 instructions, 122 bytes) */
...
/* $011C68-$011C78  (8 instructions, 16 bytes) */
...
/* $011C78-$011C88  (8 instructions, 16 bytes) */
void sub_011C78(void) {
    { uint16_t _mv = (uint16_t)(_postinc16(4)); bus_write16(g_m68k.a[2], _mv); M68K_TST16(_mv); }
    { uint16_t _mv = (uint16_t)(_postinc16(4)); bus_write16(g_m68k.a[2], _mv); M68K_TST16(_mv); }
    { uint16_t _mv = (uint16_t)(_postinc16(4)); bus_write16(g_m68k.a[2], _mv); M68K_TST16(_mv); }
    { uint16_t _mv = (uint16_t)(_postinc16(4)); bus_write16(g_m68k.a[2], _mv); M68K_TST16(_mv); }
...
/* $011C88-$011C98  (8 instructions, 16 bytes) */
...
/* $011C98-$011CAA  (9 instructions, 18 bytes) */
void sub_011C98(void) {
    { uint16_t _mv = (uint16_t)(_postinc16(4)); bus_write16(g_m68k.a[2], _mv); M68K_TST16(_mv); }
    { uint16_t _mv = (uint16_t)(_postinc16(4)); bus_write16(g_m68k.a[2], _mv); M68K_TST16(_mv); }
    { uint16_t _mv = (uint16_t)(_postinc16(4)); bus_write16(g_m68k.a[2], _mv); M68K_TST16(_mv); }
    { uint16_t _mv = (uint16_t)(_postinc16(4)); bus_write16(g_m68k.a[2], _mv); M68K_TST16(_mv); }
