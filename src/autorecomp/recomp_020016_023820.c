...
/* $020080-$020100  (58 instructions, 128 bytes) */
void jt_020080(void) {
    { uint8_t _mv = (uint8_t)(_postinc8(7)); g_m68k.a[7] -= 1; bus_write8(g_m68k.a[7], _mv); M68K_TST8(_mv); }
    ...
    g_m68k.d[4] = (g_m68k.d[4] & 0xFFFFFF00u) | ((uint8_t)(bus_read8(g_m68k.a[7]))); M68K_TST8((uint8_t)g_m68k.d[4]);
    g_m68k.d[3] = (g_m68k.d[3] & 0xFFFFFF00u) | ((uint8_t)(bus_read8(g_m68k.a[6]))); M68K_TST8((uint8_t)g_m68k.d[3]);
    M68K_SUB32(g_m68k.d[3], bus_read32(g_m68k.a[6]));
    { uint32_t _ea = g_m68k.a[0]; uint32_t _tmp = bus_read32(_ea); M68K_SUB32(_tmp, g_m68k.d[3]); bus_write32(_ea, _tmp); }
    M68K_SUB32(g_m68k.d[4], _postinc32(1));
    M68K_SUB32(g_m68k.d[5], _postinc32(3));
    { uint32_t _ea = g_m68k.a[7]; uint32_t _tmp = bus_read32(_ea); M68K_SUB32(_tmp, g_m68k.d[7]); bus_write32(_ea, _tmp); }
    M68K_OR32(g_m68k.d[0], g_m68k.d[0]);
    /* TODO $020096: dc.w $8181  [81 81] */
    M68K_OR32(g_m68k.d[1], g_m68k.d[3]);
    /* TODO $02009A: dc.w $8383  [83 83] */
    M68K_BTST(g_m68k.d[2], g_m68k.d[1]);
    M68K_BTST(g_m68k.d[1], g_m68k.d[0]);
    M68K_BTST(g_m68k.d[0], g_m68k.d[0]);
    { uint32_t _ea = g_m68k.a[2]; uint8_t _tmp = bus_read8(_ea); M68K_OR8(_tmp, 0x19); bus_write8(_ea, _tmp); }
    { uint8_t _mv = (uint8_t)(_postinc8(1)); g_m68k.a[4] -= 1; bus_write8(g_m68k.a[4], _mv); M68K_TST8(_mv); }
    g_m68k.d[4] = (g_m68k.d[4] & 0xFFFFFF00u) | ((uint8_t)(bus_read8(g_m68k.a[7]))); M68K_TST8((uint8_t)g_m68k.d[4]);
    { uint8_t _mv = (uint8_t)(bus_read8(g_m68k.a[7])); /* UNHANDLED_WRITE: (a1.w * 8) = _mv */ M68K_TST8(_mv); }
    { uint32_t _ea = g_m68k.a[1]; uint32_t _tmp = bus_read32(_ea); M68K_SUB32(_tmp, g_m68k.d[4]); bus_write32(_ea, _tmp); }
    M68K_SUB32(g_m68k.d[5], _postinc32(3));
    M68K_SUB32(g_m68k.d[6], g_m68k.d[0]);
    M68K_OR32(g_m68k.d[0], g_m68k.d[1]);
    M68K_OR32(g_m68k.d[1], g_m68k.d[2]);
    M68K_OR32(g_m68k.d[1], g_m68k.d[3]);
    M68K_OR32(g_m68k.d[2], g_m68k.d[4]);
    M68K_OR8(g_m68k.d[2], g_m68k.d[4]);
    M68K_BTST(g_m68k.d[2], g_m68k.d[1]);
    M68K_AND8(g_m68k.d[2], 0x1);
    ...
    g_m68k.d[5] = (g_m68k.d[5] & 0xFFFFFF00u) | ((uint8_t)(_postinc8(1))); M68K_TST8((uint8_t)g_m68k.d[5]);
    g_m68k.d[4] = (g_m68k.d[4] & 0xFFFFFF00u) | ((uint8_t)(_postinc8(0))); M68K_TST8((uint8_t)g_m68k.d[4]);
    M68K_SUB32(g_m68k.d[4], _postinc32(0));
    { uint32_t _ea = g_m68k.a[2]; uint32_t _tmp = bus_read32(_ea); M68K_SUB32(_tmp, g_m68k.d[4]); bus_write32(_ea, _tmp); }
    M68K_SUB32(g_m68k.d[5], _postinc32(3));
    M68K_SUB32(g_m68k.d[6], _postinc32(5));
    /* TODO $0200D4: dc.w $8181  [81 81] */
    M68K_OR32(g_m68k.d[1], g_m68k.d[3]);
    /* TODO $0200D8: dc.w $8383  [83 83] */
    M68K_OR32(g_m68k.d[2], g_m68k.d[5]);
    /* TODO $0200DC: dc.w $8585  [85 85] */
    M68K_BTST(g_m68k.d[4], g_m68k.d[2]);
    M68K_BTST(g_m68k.d[3], g_m68k.d[1]);
    M68K_BTST(g_m68k.d[2], g_m68k.d[1]);
    { uint32_t _ea = g_m68k.a[4]; uint8_t _tmp = bus_read8(_ea); M68K_AND8(_tmp, 0x1b); bus_write8(_ea, _tmp); }
    { uint8_t _mv = (uint8_t)(_postinc8(3)); g_m68k.a[5] -= 1; bus_write8(g_m68k.a[5], _mv); M68K_TST8(_mv); }
    g_m68k.d[5] = (g_m68k.d[5] & 0xFFFFFF00u) | ((uint8_t)(_postinc8(1))); M68K_TST8((uint8_t)g_m68k.d[5]);
    { uint8_t _mv = (uint8_t)(_postinc8(1)); /* UNHANDLED_WRITE: ([, a1.l], $9b9b) = _mv */ M68K_TST8(_mv); }
    M68K_SUB32(g_m68k.d[6], _postinc32(5));
    M68K_SUB32(g_m68k.d[7], g_m68k.d[2]);
    /* TODO $0200F6: dc.w $8383  [83 83] */
    M68K_OR32(g_m68k.d[2], g_m68k.d[4]);
    M68K_OR32(g_m68k.d[2], g_m68k.d[5]);
