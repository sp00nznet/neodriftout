...
void sub_007E1C(void) {
    ...
    func_table_call(0x008172); /* sub_008172 */
    ...
    func_table_call(0x00805C); /* sub_00805C */
    func_table_call(0x007F50); /* sub_007F50 */
...
/* $007EDA-$007EE8  (4 instructions, 14 bytes) */
void sub_007EDA(void) {
    func_table_call(0x008092); /* sub_008092 */
    func_table_call(0x007F50); /* sub_007F50 */
    g_m68k.d[0] = (g_m68k.d[0] & 0xFFFF0000u) | ((uint16_t)(0x1)); M68K_TST16((uint16_t)g_m68k.d[0]);
    return;
}
...
/* $007F32-$007F50  (8 instructions, 30 bytes) */
...
/* $007F50-$008002  (38 instructions, 178 bytes) */
void sub_007F50(void) {
...
loc_007F64:
    ...
    func_table_call(0x00802A); /* sub_00802A */
...
/* $008000-$00802A  (10 instructions, 42 bytes) */
void jt_008000(void) {
...
/* $00802A-$00805C  (14 instructions, 50 bytes) */
void sub_00802A(void) {
...
/* $00805C-$008092  (14 instructions, 54 bytes) */
void sub_00805C(void) {
...
/* $008092-$008172  (44 instructions, 224 bytes) */
void sub_008092(void) {
    ...
    if (M68K_CC_EQ) goto loc_0080AE;
    g_m68k.d[0] = (g_m68k.d[0] & 0xFFFFFF00u) | ((uint8_t)(bus_read8(0x10FD9D))); M68K_TST8((uint8_t)g_m68k.d[0]);
loc_0080AE:
    M68K_BTST(g_m68k.d[0], 0x0);
    if (M68K_CC_EQ) goto loc_0080C0;
    { uint32_t _ea = 0x1011A8; uint16_t _tmp = bus_read16(_ea); M68K_SUB16(_tmp, 0x1); bus_write16(_ea, _tmp); }
    goto loc_0080CE;
loc_0080C0:
    M68K_BTST(g_m68k.d[0], 0x1);
    if (M68K_CC_EQ) goto loc_008104;
    { uint32_t _ea = 0x1011A8; uint16_t _tmp = bus_read16(_ea); M68K_ADD16(_tmp, 0x1); bus_write16(_ea, _tmp); }
loc_0080CE:
    g_m68k.d[0] = (g_m68k.d[0] & 0xFFFF0000u) | ((uint16_t)(0xc6)); M68K_TST16((uint16_t)g_m68k.d[0]);
    func_table_call(0x015256);
    M68K_CMP16(bus_read16(0x1011A8), 0x1);
    if (M68K_CC_LE) goto loc_0080EE;
    bus_write16(0x1011A8, 0); g_m68k.flag_n = false; g_m68k.flag_z = true; g_m68k.flag_v = false; g_m68k.flag_c = false;
    goto loc_00816C;
loc_0080EE:
    M68K_TST16(bus_read16(0x1011A8));
    if (M68K_CC_PL) goto loc_00816C;
    { uint16_t _mv = (uint16_t)(0x1); bus_write16(0x1011A8, _mv); M68K_TST16(_mv); }
    goto loc_00816C;
loc_008104:
    M68K_BTST(g_m68k.d[0], 0x4);
    if (M68K_CC_EQ) goto loc_008122;
    g_m68k.d[0] = (g_m68k.d[0] & 0xFFFF0000u) | ((uint16_t)(0x186e)); M68K_TST16((uint16_t)g_m68k.d[0]);
    func_table_call(0x015256);
    { uint16_t _mv = (uint16_t)(0x1); bus_write16(0x1011AE, _mv); M68K_TST16(_mv); }
    goto loc_00816C;
loc_008122:
    ...
    if (M68K_CC_EQ) goto loc_008152;
    M68K_BTST(g_m68k.d[0], 0x0);
    if (M68K_CC_EQ) goto loc_00816C;
    g_m68k.d[0] = (g_m68k.d[0] & 0xFFFF0000u) | ((uint16_t)(0x186e)); M68K_TST16((uint16_t)g_m68k.d[0]);
    func_table_call(0x015256);
    { uint16_t _mv = (uint16_t)(0x1); bus_write16(0x1011AE, _mv); M68K_TST16(_mv); }
    goto loc_00816C;
...
/* $008172-$008192  (8 instructions, 32 bytes) */
void sub_008172(void) {
