...
/* $0F7A30-$0F7A32  (1 instructions, 2 bytes) */
void jt_0F7A30(void) {
    M68K_OR16(g_m68k.d[3], g_m68k.d[0]);
    /* WARNING: function did not end with RTS */
}

/* $0F7AD4-$0F7AD6  (1 instructions, 2 bytes) */
void jt_0F7AD4(void) {
    M68K_ASR16(g_m68k.d[0], 0x8);
    /* WARNING: function did not end with RTS */
}

/* $0F7ADC-$0F7AE0  (2 instructions, 4 bytes) */
void jt_0F7ADC(void) {
    /* TODO $0F7ADC: dc.w $ff10  [FF 10] */
