...
/* $0130BE-$0133FA  (235 instructions, 828 bytes) */
void jt_0130BE(void) {
    { uint16_t _mv = (uint16_t)(0x1); bus_write16(g_m68k.a[2] + 0x2, _mv); M68K_TST16(_mv); }
    { uint16_t _mv = (uint16_t)(_postinc16(4)); bus_write16(g_m68k.a[2], _mv); M68K_TST16(_mv); }
    g_m68k.a[4] += 0x1;
...
loc_01338C:
    ...
    return;
loc_0133A0:
    func_table_call(0x013330); /* loc_013330 */
...
loc_013510:
    func_table_call(0x013706); /* loc_013706 */
    M68K_ADD16(g_m68k.d[0], 0x1);
...
loc_01360C:
    ...
    func_table_call(0x013CAA); /* loc_013CAA */
    func_table_call(0x013D34); /* loc_013D34 */
    m68k_set_sr(m68k_get_sr() | 0x700);
    func_table_call(0x013DB4); /* loc_013DB4 */
...
/* $0136BA-$013E14  (622 instructions, 1882 bytes) */
...
/* $013E14-$013F6A  (30 instructions, 342 bytes) */
...
/* $0141FA-$014256  (26 instructions, 92 bytes) */
