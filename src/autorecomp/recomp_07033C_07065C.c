...
/* $07050C-$07051C  (4 instructions, 16 bytes) */
void jt_07050C(void) {
    M68K_OR8(g_m68k.d[7], 0x16);
    M68K_OR8(g_m68k.d[7], 0x1e);
    M68K_OR8(g_m68k.d[7], 0x2e);
...
/* $07051C-$07052C  (4 instructions, 16 bytes) */
void jt_07051C(void) {
...
/* $07052C-$07053C  (4 instructions, 16 bytes) */
void jt_07052C(void) {
...
/* $07053C-$07054C  (4 instructions, 16 bytes) */
void jt_07053C(void) {
    M68K_OR8(g_m68k.d[7], 0xe8);
...
/* $07054C-$07055C  (4 instructions, 16 bytes) */
void jt_07054C(void) {
...
/* $07055C-$07056C  (4 instructions, 16 bytes) */
void jt_07055C(void) {
...
/* $07056C-$07057C  (4 instructions, 16 bytes) */
void jt_07056C(void) {
    M68K_OR8(g_m68k.d[7], 0x94);
    M68K_OR8(g_m68k.d[7], 0xac);
...
/* $07057C-$07058C  (4 instructions, 16 bytes) */
void jt_07057C(void) {
...
/* $07058C-$07059C  (4 instructions, 16 bytes) */
void jt_07058C(void) {
...
/* $07059C-$0705AC  (4 instructions, 16 bytes) */
void jt_07059C(void) {
    M68K_OR8(g_m68k.d[7], 0x8);
    M68K_OR8(g_m68k.d[7], 0x12);
    M68K_OR8(g_m68k.d[7], 0x1c);
...
/* $0705AC-$0705BC  (4 instructions, 16 bytes) */
void jt_0705AC(void) {
...
/* $0705BC-$0705CC  (4 instructions, 16 bytes) */
void jt_0705BC(void) {
    M68K_OR8(g_m68k.d[7], 0x50);
    M68K_OR8(g_m68k.d[7], 0x58);
...
/* $0705CC-$0705DC  (4 instructions, 16 bytes) */
void jt_0705CC(void) {
    M68K_OR8(g_m68k.d[7], 0x24);
...
/* $0705DC-$0705EC  (4 instructions, 16 bytes) */
void jt_0705DC(void) {
    M68K_OR8(g_m68k.d[7], 0xf8);
    M68K_OR8(g_m68k.d[7], 0x20);
    M68K_OR8(g_m68k.d[7], 0x56);
...
/* $0705EC-$0705FC  (4 instructions, 16 bytes) */
void jt_0705EC(void) {
...
/* $0705FC-$07060C  (4 instructions, 16 bytes) */
void jt_0705FC(void) {
    M68K_OR8(g_m68k.d[7], 0xe);
    M68K_OR8(g_m68k.d[7], 0x26);
...
/* $07060C-$07061C  (4 instructions, 16 bytes) */
void jt_07060C(void) {
    M68K_OR8(g_m68k.d[7], 0x6a);
    M68K_OR8(g_m68k.d[7], 0xaa);
    M68K_OR8(g_m68k.d[7], 0xb8);
...
/* $07061C-$07062C  (4 instructions, 16 bytes) */
void jt_07061C(void) {
    M68K_OR8(g_m68k.d[7], 0x16);
    M68K_OR8(g_m68k.d[7], 0x20);
    M68K_OR8(g_m68k.d[7], 0x38);
...
/* $07062C-$07063C  (4 instructions, 16 bytes) */
void jt_07062C(void) {
    M68K_OR8(g_m68k.d[7], 0x74);
    M68K_OR8(g_m68k.d[7], 0x8e);
    M68K_OR8(g_m68k.d[7], 0xa4);
...
/* $07063C-$07064C  (4 instructions, 16 bytes) */
void jt_07063C(void) {
    M68K_OR8(g_m68k.d[7], 0xe8);
    M68K_OR8(g_m68k.d[7], 0xfc);
    M68K_OR8(g_m68k.d[7], 0x20);
...
/* $07064C-$07065C  (4 instructions, 16 bytes) */
void jt_07064C(void) {
