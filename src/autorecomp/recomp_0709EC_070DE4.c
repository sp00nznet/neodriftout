...
/* $070CA4-$070CBC  (12 instructions, 24 bytes) */
void jt_070CA4(void) {
    /* TODO $070CA4: dc.w $ff16  [FF 16] */
    M68K_AND8(g_m68k.d[0], bus_read8(g_m68k.a[6]));
    /* TODO $070CA8: dc.w $8140  [81 40] */
