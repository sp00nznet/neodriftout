...
/* $000A8C-$000BBA  (42 instructions, 302 bytes) */
void jt_000A8C(void) {
    /* nop */
...
/* $000C54-$000CAA  (19 instructions, 86 bytes) */
void jt_000C54(void) {
...
/* $000D08-$000D34  (8 instructions, 44 bytes) */
void jt_000D08(void) {
    { uint16_t _mv = (uint16_t)(0x2); bus_write16(0x100426, _mv); M68K_TST16(_mv); }
    goto loc_000D22;
loc_000D12:
...
/* $000D9A-$000DBC  (7 instructions, 34 bytes) */
void jt_000D9A(void) {
    { uint16_t _mv = (uint16_t)(0x0); bus_write16(0x10042E, _mv); M68K_TST16(_mv); }
    func_table_call(0x01A094);
    M68K_CMP16(g_m68k.d[0], 0x0);
    if (M68K_CC_NE) { func_table_call(0x000DC6); return; }
    M68K_CMP16(g_m68k.d[1], 0x0);
    if (M68K_CC_NE) { func_table_call(0x000DBE); return; }
    { uint16_t _mv = (uint16_t)(0x5); bus_write16(0x100426, _mv); M68K_TST16(_mv); }
    /* WARNING: function did not end with RTS */
}

/* $000DB6-$000DC8  (5 instructions, 18 bytes) */
void jt_000DB6(void) {
    M68K_OR8(g_m68k.d[5], 0x10);
    { uint32_t _ea = g_m68k.a[6]; uint8_t _tmp = bus_read8(_ea); M68K_SUB8(_tmp, 0x8); bus_write8(_ea, _tmp); }
    goto loc_000DC6;
loc_000DBE:
