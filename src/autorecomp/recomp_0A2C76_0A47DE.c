...
/* $0A2E3E-$0A2E52  (6 instructions, 20 bytes) */
void jt_0A2E3E(void) {
    M68K_OR8(g_m68k.d[2], 0x2);
    M68K_CMP32(g_m68k.d[6], bus_read32(0xa2e44 + (int16_t)(uint16_t)g_m68k.d[4] * 4));
    M68K_CMP32(g_m68k.a[6], (uint32_t)(int32_t)(int16_t)(uint16_t)(g_m68k.d[5]));
    M68K_NEG8(g_m68k.d[0]);
    M68K_CMP32(g_m68k.d[6], 0x4400bcc6);
    M68K_NEG8(g_m68k.d[0]);
    /* WARNING: function did not end with RTS */
}
