...
/* Auto-generated function declarations and registration from the
 * 68k-to-C code generator (tools/generate_recomp.py).
 * Contains 6,475 function declarations and recomp_register_all(). */
...
static void register_functions(void) {
    /*
     * Register all 6,475 auto-generated recompiled functions.
     * Generated by tools/generate_recomp.py from the CPS1/SF2 toolchain
     * (adapted for Neo Geo ROM format).
     */
    recomp_register_all();

    printf("[neodriftout] Registered %u functions (auto-generated)\n",
           func_table_count());
}
